...
function SearchInput({ placeholder = '百度一下' }: { placeholder?: string }) {
	...
	return (
		<>
			<input type='text' placeholder={placeholder} className='BM-h-full BM-w-0 BM-flex-1 BM-bg-transparent BM-px-10 dark:BM-text-white dark:placeholder:BM-text-white/50' ref={inputRef} onKeyUp={e => inputEnter(e)} />
			<div className='BM-flex BM-h-36 BM-w-36 BM-shrink-0 BM-cursor-pointer BM-items-center BM-justify-center BM-rounded-full BM-bg-main' onClick={handleSearch}>
