	...
	return (
		<div className='BM-h-80 BM-flex BM-items-center BM-rounded-[0_20px_0_0] BM-justify-center lg:BM-justify-start BM-sticky BM-top-0 BM-pb-10'>
			...
			<span className='BM-text-26 BM-text-333'>
				<b className='BM-text-main BM-font-bold BM-align-bottom DIN'>BM</b>
				<span className='BM-font-thin dark:BM-text-white BM-align-middle'>快捷导航</span>
				<sub className='BM-text-main BM-text-18 BM-ml-[0.5em] DIN'>v{packageJson.version}</sub>
			</span>
			<div className='BM-absolute BM-left-5 BM-top-2/4 BM-translate-y-[-50%] lg:BM-hidden'>
				<svg className='BM-fill-999 BM-cursor-pointer dark:BM-fill-darkTextWhite' viewBox='0 0 1024 1024' width='32' height='32' data-open={true} onClick={() => props.setSideVisible(true)}>
